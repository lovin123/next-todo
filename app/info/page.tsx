  ...
  return (
    <main className="flex flex-col gap-3 px-4">
      ...
      <p className="border-b-2">
        ...
        want to register. test user email is test@test.com and password is test
      </p>
      <ul>
        <li>
          Github repository{" "}
          <a
            href="https://github.com/lovin123/next-todo"
            target="_blank"
        ...
        <li>
          My github account{" "}
          <a
            href="https://github.com/lovin123"
            target="_blank"
            className="font-extrabold"
          >
            Click
        ...
        <li>
          My Linkedin account{" "}
          <a
            href="https://www.linkedin.com/in/lovintanwar"
            target="_blank"
            className="font-extrabold"
          >
            Click
